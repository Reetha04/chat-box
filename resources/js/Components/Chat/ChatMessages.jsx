                ...
                (messages || []).map((message, index) => (
                    <Fragment key={index}>
                        <div className={`${
                            ...
                            <div className={` mb-2 max-w-[80%] rounded ${isReceivedMessage(message) ? 'bg-violet-400' : 'bg-violet-200'}
                             px-5 py-2 text-sm ${isReceivedMessage(message) ? 'text-white' : 'text-slate-500'} font-light`}>
                                <p>
                                    {message?.message}
                                </p>
                            </div>
